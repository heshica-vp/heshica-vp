...
### Data Science Intern @ Genpact
*Jan 2025 - June 2025 | Bengaluru*

- Architected **multi-agent insurance claim validation system** using AutoGen, LangGraph, Azure OpenAI
...
- Automated ETL workflows using LangChain and Llama 3.1, cutting data entry time by **60%**
...
`LangChain` `LangGraph` `AutoGen` `Semantic Kernel` `OpenAI SDK` `RAG` `MCP`

**AI/ML Frameworks**  
`PyTorch` `TensorFlow` `Scikit-learn` `DistilBERT` `Sentence Transformers` `Llama 3.1`

**Databases & Vector Search**  
`FAISS` `Azure AI Search` `ChromaDB` `Pinecone` `PostgreSQL` `MongoDB` `SingleStore DB`

**Backend & Infrastructure**  
`Python` `SQL` `FastAPI` `Docker` `Kubernetes` `Azure OpenAI` `Git`

---

## 🚀 What I Build

I specialize in **agentic AI systems**, **RAG pipelines**, and **LLM-powered applications** that solve real-world problems. I take ownership of projects end-to-end — from design to deployment — and focus on delivering measurable impact.
...
B.Tech in Computer Science Engineering (Data Science) | 2021-2025
...
💼 **Looking for:** AI Engineer / Data Scientist / Generative AI roles
